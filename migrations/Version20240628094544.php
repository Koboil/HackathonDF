 ...
 */
final class Version20240628094544 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT NOT NULL, question_id_id INT NOT NULL, patient_id_id INT NOT NULL, response VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE patient (id INT NOT NULL, gender VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, birth_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, phone_number INT NOT NULL, PRIMARY KEY(id))');
