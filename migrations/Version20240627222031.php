 ...
 */
final class Version20240627222031 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT NOT NULL, questionÂ_id_id INT NOT NULL, patient_id_id INT NOT NULL, response TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_B6BD307F7C3E4A3F ON message (questionÂ_id_id)');
        ...
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307F7C3E4A3F FOREIGN KEY (questionÂ_id_id) REFERENCES questions (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message DROP CONSTRAINT FK_B6BD307F7C3E4A3F');
